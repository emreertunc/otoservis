<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="defaultkopya.aspx.cs" Inherits="Proje.Web.defaultkopya" %>
                        ...
                        <ul class="nav-right">
                                    ...
                                    <li>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="notification-user">Emre Ertunç</h5>
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        <a href="/Tasarim/auth-normal-sign-in.aspx">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-40 img-radius" src="/Tasarim/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="/Tasarim/auth-normal-sign-in.aspx"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/breadcrumb.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/label-badge.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/typography.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/notification.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/icon-themify.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="/Tasarim/form-elements-component.aspx">
                                ...
                                <li>
                                    <a href="/Tasarim/bs-basic-table.aspx">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li>
                                    <a href="/Tasarim/map-google.aspx">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/auth-sign-up.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="/Tasarim/sample-page.aspx">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                            ...
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-3.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="to-do-list">
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-3.jpg" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-4.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img src="/Tasarim/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
...
<!-- modernizr js -->
<script type="text/javascript" src="/Tasarim/assets/js/modernizr/modernizr.js"></script>
<!-- am chart -->
<script src="/Tasarim/assets/pages/widget/amchart/amcharts.min.js"></script>
<script src="/Tasarim/assets/pages/widget/amchart/serial.min.js"></script>
<!-- Todo js -->
<script type="text/javascript " src="/Tasarim/assets/pages/todo/todo.js "></script>
<!-- Custom js -->
<script type="text/javascript" src="/Tasarim/assets/pages/dashboard/custom-dashboard.js"></script>
<script type="text/javascript" src="/Tasarim/assets/js/script.js"></script>
<script type="text/javascript " src="/Tasarim/assets/js/SmoothScroll.js"></script>
<script src="/Tasarim/assets/js/pcoded.min.js"></script>
<script src="/Tasarim/assets/js/demo-12.js"></script>

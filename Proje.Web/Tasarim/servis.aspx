                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" style="overflow: visible;">
                                ...
                                <asp:GridView ID="GridViewServisList" Width="100%" CssClass="table table-bordered table-borderless table-hover" runat="server" AutoGenerateDeleteButton="True" OnRowDeleting="GridViewServisList_RowDeleting" AutoGenerateSelectButton="True" OnSelectedIndexChanged="GridViewServisList_SelectedIndexChanged">
                                </asp:GridView>
                                <br />
                            </div>
                        </div>

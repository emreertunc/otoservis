...
{
    public partial class icon_themify2 : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (query1.Count != 0)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "CallMyFunction", "showContentWarning('Marka zaten mevcut, güncelleme işlemi gerçekleştirilemedi', 'HATA');", true);
            }

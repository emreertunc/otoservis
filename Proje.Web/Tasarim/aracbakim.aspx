            ...
            <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card mb-3" style="background-color: lightgray">
                            <div class="card-header">
                                <h4>Marka/Model ve Müşteri ID Tabloları</h4>
                                <span></span>
                                <div class="card-header-right">
                                    <ul class="list-unstyled card-option" style="width: 35px;">
                                        <li class=""><i class="icofont icofont-simple-left"></i></li>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive" style="overflow: visible;">
                                        <asp:Table runat="server">
                                            ...
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:GridView ID="GridViewIDList" runat="server" Width="100%" CssClass="table table-bordered table-hover" AllowPaging="True" OnPageIndexChanging="GridViewIDList_PageIndexChanging"></asp:GridView>
                                                </asp:TableCell>
                                                <asp:TableCell></asp:TableCell>
                                                <asp:TableCell></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:GridView ID="GridViewMusteriID" runat="server" Width="100%" CssClass="table table-bordered table-hover" AllowPaging="True" OnPageIndexChanging="GridViewMusteriID_PageIndexChanging"></asp:GridView>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>

...
{
    public partial class servisislemdeneme : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("servisdeneme.aspx");
        }
        ...
        protected void GridViewServisList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("servisislemdeneme.aspx?serviskod=" + serviskodu.ToString());
        }
